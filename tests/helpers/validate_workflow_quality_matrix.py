...
SAMPLE_RULES: dict[str, dict[str, Any]] = {
    ...
    "bounded-preservation-multi-role-repair": {
        ...
        "allowed": ["first-principles-review"],
        "must_not": [
            "patch-precedence-without-role-check",
            "delete-parent-selector-capability",
            "claim-exhaustive-preserved-behavior",
            "turn-preservation-reminder-into-runtime-gate",
        ],
        "signals": [
            ...
            "material-unknown",
            "role-before-value",
            "invalid-responsibility-retired",
            "legitimate-capability-retained",
    ...
    "bounded-preservation-shared-config-role": {
        ...
        "allowed": ["first-principles-review"],
        "must_not": [
            "treat-config-key-as-single-role",
            "drop-explicit-profile-reference",
            "guess-uninspected-consumers",
            "add-semantic-graph-artifact",
        ],
        "signals": [
            "bounded-preservation",
            "existing-semantics-responsibility-relationship",
            "explicit-anchor-disposition",
            "upstream-downstream-reference",
            "preserve-rebind-retire-reject",
