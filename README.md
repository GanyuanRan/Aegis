...
| `CC GUI (JetBrains IDEA)` | Structural IDE plugin layer support for Claude Code / Codex; release-level fresh host smoke is still pending | [CC GUI](docs/README.cc-gui.md) |
